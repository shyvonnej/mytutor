...
<div class="w3-top">
  ...
  <header class="w3-display-container w3-content" style="max-width:1400px;" id="home">
    <img class="w3-image" src="../res/pics/tutors.jpg" alt="Homepage" style="width:1400px; height:300px; object-fit: cover; filter: brightness(50%);">
    <div class="w3-display-middle w3-margin-top w3-margin-left w3-center" style="max-width:1400px;">
      <h1 class="w3-xxlarge w3-text-white"><span class=" w3-text-light-grey"><b>Tutors Partnered with MY Tutor</b></span></h1>
      </h1>
    </div>
  </header>
    ...
    <div class="w3-grid-template w3-margin-right w3-margin-left">
      <?php
        ...
        echo "<div class='w3-card-4 w3-round' style='margin: 10px'><header class='w3-container w3-black'><b>$tutorname</b>
